...
namespace LoveLetter.Core.Queries
{
    public static class LobbyQuery
    {
        ...
        public static string Insert(string player) => $"INSERT INTO {Tables.Lobbies} (Id, Status, Players) VALUES ({Guid.NewGuid()}, {LobbyStatus.Open}, {new string[1] { player }})";
        ...
        public static string UpdatePlayers(Guid lobbyId, IEnumerable<string> players) => $"UPDATE {Tables.Lobbies} SET Players={players} WHERE Id={lobbyId}";
    }
}
